...
public class EquipShowItemFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if ((eIntent != null) && eIntent.hasExtra(equipIdent_ITEM) && (!eIntent.getStringExtra(equipIdent_ITEM).isEmpty()) ) {
            ...
            getActivity().setTitle(getResources().getString(R.string.title_EquipEditorActivity_ItemDetail));

            thisItem = new ItemClassInterfaceHelper(getActivity(), rootView, itemIdent,null);
