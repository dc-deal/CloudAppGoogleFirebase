...
import static net.livingrecordings.giggermainapp.giggerMainClasses.GiggerIntentHelperClass.EditorEquipType_CATEGORY;
import static net.livingrecordings.giggermainapp.giggerMainClasses.GiggerIntentHelperClass.EditorEquipType_ITEM;
...
import static net.livingrecordings.giggermainapp.giggerMainClasses.GiggerIntentHelperClass.GHC_Type;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (eIntent != null && eIntent.hasExtra(GHC_mode)) {
            ...
            // was genau edit oder new wird dann im fragment entschieden!!
                ...
                ft.replace(R.id.placeholder_editfragment, new EquipEditCategoryFragment());
                ft.commit();
            }
